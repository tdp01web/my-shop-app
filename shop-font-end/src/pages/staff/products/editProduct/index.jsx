      ...
      <div className="mx-auto max-w-3xl">
        <Form
          ...
          initialValues={{
            ...
            variants: product?.data?.variants?.filter((item) => item.status === 1)?.map((item) => ({
        ...
        >
          ...
          >
            <TextArea rows={4} className="pointer-events-none" />
          </Form.Item>
          <Form.Item
          ...
          >
            <Input placeholder="Nhập kích thước" className="pointer-events-none" />
          </Form.Item>
          <Form.Item
            label="Danh mục"
            name="category"
                    ...
                    >
                      <Form.Item key={key} required={false} >
                        ...
                        >
                          ...
                          >
                            <InputNumber style={{ width: "100%" }} className="pointer-events-none" />
                          </Form.Item>
                          <Form.Item
                            {...restField}
                            label={"Số lượng "}
...
export default EditProductStaff;
