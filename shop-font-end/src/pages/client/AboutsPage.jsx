    ...
    <>
      <div className="md:mx-auto px-4 md:px-6 lg:px-20 py-9 md:py-12 lg:py-16 md:w-[80%]">
        ...
        <div className="mt-12 sm:mt-10 lg:mt-14">
          <img className="rounded-md w-full h-[300px] md:h-[500px] object-cover" src="./public/images/abouts/logo.jpg" />
        </div>
        ...
        <div className="flex lg:flex-row flex-col justify-between gap-12 lg:gap-8 mt-16 sm:mt-12 lg:mt-16">
          ...
          <div className="lg:flex items-center w-full lg:w-1/2">
            <img className="lg:block rounded-md w-full object-cover" src="./public/images/abouts/images.jpg" alt="people discussing on board" />
          </div>
        </div>
        <div className="gap-4 grid grid-cols-2 my-5">
          <div className="w-full">
            <img src="./public/images/abouts/abouts1.jpg" alt="Large Image" className="rounded-md w-full h-full object-cover" />
          </div>
          <div className="gap-4 grid grid-cols-2 grid-rows-2 w-full">
            <div className="col-span-1">
              <img src="./public/images/abouts/abouts2.jpg" alt="Image 1" className="rounded-md w-full h-full object-cover" />
            </div>
            <div className="col-span-1">
              <img src="./public/images/abouts/abouts3.jpg" alt="Image 2" className="rounded-md w-full h-full object-cover" />
            </div>
            <div className="col-span-1">
              <img src="./public/images/abouts/abouts4.jpg" />
            </div>
            <div className="col-span-1">
              <img src="./public/images/abouts/abouts5.jpg" alt="Image 4" className="rounded-md w-full h-full object-cover" />
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="flex lg:flex-row flex-col justify-between gap-12 lg:gap-8 mt-16 sm:mt-12 lg:mt-16">
            <div className="w-full lg:w-6/12 xl:w-5/12">
              ...
              <img src="./public/images/abouts/download.png" alt="" />
            ...
            <div className="w-full lg:w-6/12 xl:w-5/12">
              ...
              <img src="./public/images/abouts/download2.png" alt="" />
