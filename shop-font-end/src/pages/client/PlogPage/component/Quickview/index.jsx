...
const Quickview = () => {
  return (
    <>
      ...
      <div className="  bg-white rounded row mb-[80px]">
        <div className="flex pt-[16px]">
          ...
          <div className="w-2/3 sm:w-9/12 ">
            ...
            >
              Janitor AI là gì? Những tính năng nổi bật và cách dùng Janitor AI
              Chat
            </a>
        ...
        <div className="flex pt-[16px]">
          ...
          <div className="w-2/3 sm:w-9/12 ">
            <a
              ...
              className="font-semibold text-[13px] hover:text-red-500 "
            >
              Hướng dẫn chọn PC cho học sinh, sinh viên để sẵn sàng cho mùa Back
              to School
            </a>
          </div>
        </div>
        ...
        <div className="flex pt-[16px]">
          ...
          <div className="w-2/3 sm:w-9/12 ">
            <a
              ...
              className="font-semibold text-[13px] hover:text-red-500 "
            >
              Top 5 màn hình gaming 24-inch giá tốt dịp Back to School 2024
            </a>
          </div>
        </div>
      </div>
