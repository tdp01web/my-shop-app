...
const TransferPayment = (_, ref) => {
  return (
    <div className="bg-white pb-[64px] px-4" ref={ref}>
      <div className="grid grid-cols-12 gap-y-8 gap-x-0 md:gap-x-8 w-full">
        ...
        <div className="col-span-12 md:col-span-6">
          ...
          >
            <span>
              Quý khách hàng có thể thanh toán đơn hàng bằng cách chuyển khoản
              qua tài khoản của GEARVN tại ngân hàng dưới đây và liên hệ{" "}
            </span>
            <span className="font-bold underline">Hotline 1900 5301</span>
            <span> để xác nhận thông tin</span>
          </a>

          <div className="flex-col md:flex-row mt-8 mb-3 bg-[#edf6ff] p-8 flex items-center gap-x-3 rounded-2xl">
