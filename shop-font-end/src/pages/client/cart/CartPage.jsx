        ...
        <div class=" w-full  sm:w-3/4 bg-white px-10 py-10">
          ...
          <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
            <div class="md:w-4/12 2xl:w-1/4 w-full">
              <img
                src="https://cdn2.fptshop.com.vn/unsafe/384x0/filters:quality(100)/2023_9_20_638307980220145280_iphone-15-promax-den-1.jpg"
              ...
              <img
                src="https://cdn2.fptshop.com.vn/unsafe/384x0/filters:quality(100)/2023_9_20_638307980220145280_iphone-15-promax-den-1.jpg"
                alt="Black Leather Purse"
                class="md:hidden sm:w-4/12 object-center object-cover"
              />
            </div>
            <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
              <p class=" leading-3 text-gray-800 md:pt-0 pt-4">mã máy</p>
              <div class="flex items-center justify-between w-full">
                <p class="font-black leading-none text-gray-800 text-[16px]">
              ...
              <div class="flex items-center justify-between pt-5">
                <div class="flex itemms-center">
                  <p class="leading-3 text-gray-800 font-bold cursor-pointer line-through">
                    34.990.000 ₫ 16%
                  </p>
                  <p class="leading-3 font-bold text-red-500 pl-5 cursor-pointer">
                    29.490.000 ₫
                  </p>
                </div>
                <Popconfirm
          ...
          <Link
            to="/"
            class="flex font-semibold text-indigo-600 text-[17px] mt-10"
          >
            <svg
