    ...
    <div className="px-6 py-4">
      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-12 gap-4 mt-6">
          <div className="col-span-12 md:col-span-8 border rounded p-4">
          ...
          <div className="col-span-12 md:col-span-4 border rounded p-4">
            <div className="flex items-center gap-x-3 mb-3">
          ...
          {order.products.map((product) => (
            <div key={product._id} className="flex justify-between mb-4">
              <div className="flex items-center">
                ...
                />
                <div>
                  <p>{product.title} | {product.gpu} | {product.ram} | {product.storage}</p>
