...
import { useGetGPUByID } from "../../../../../hooks/queries/useGetGPUByID";
import { usePutGPU } from "../../../../../hooks/mutations/usePutGPU";
...
const EditGPU = () => {
  ...
  const { mutate, isPending } = usePutGPU(id, {
    onSuccess: () => {
      messageApi.open({
        type: "success",
        content: "Sửa GPU thành công",
      });
      setTimeout(() => {
        navigate('/admin/gpu');
      }, 1000);
