...
import { useDeleteGPU } from "../../../../hooks/mutations/useDeleteGPU";
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-5">
        <h1 className="font-semibold text-2xl">Quản lý GPU</h1>
        <Button type="primary">
          <Link to="/admin/gpu/add">
            <PlusCircleFilled /> Thêm GPU
          </Link>
        </Button>
      </div>
