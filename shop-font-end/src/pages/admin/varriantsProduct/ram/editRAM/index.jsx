...
import { useGetRAMByID } from "../../../../../hooks/queries/useGetRAMByID";
import { usePutRAM } from "../../../../../hooks/mutations/usePutRAM";
...
const EditRAM = () => {
  ...
  const { mutate, isPending } = usePutRAM(id, {
    onSuccess: () => {
      messageApi.open({
        type: "success",
        content: "Sửa RAM thành công",
      });
      setTimeout(() => {
        navigate('/admin/ram');
      }, 1000);
